...
<body>
 <div class="container">
    <h1> Привет, Амиго! </h1>
    <h2> req.getParameter("header") </h2>
<p class="d-inline-flex gap-1">
  <button type="button" class="btn" data-bs-toggle="button">req.getParameter("answer1")</button>
  <button type="button" class="btn active" data-bs-toggle="button" aria-pressed="true">req.getParameter("answer2")</button>
</p>
